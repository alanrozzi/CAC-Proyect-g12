$(document).click(function() {
    $('#boton1').click(function(){
        $('#content').html(
            ...
            '<br>'+
            '<img class="imag1" src="img/Tbbth.jpg" alt="The Big Bang Theory">' +
    ...
    $('#boton2').click(function(){
        $('#content').html(
            ...
            '<br>'+
            '<img class="imag1" src="img/GOT.jpg" alt="Game of Thrones">' +
    ...
    $('#boton3').click(function(){
        $('#content').html(
            ...
            '<h2>The Sopranos</h2>'+
            '<br>'+
            '<img class="imag1" src="img/TS.jpg" alt="The Sopranos">' +
    ...
    $('#boton4').click(function(){
        $('#content').html(
            ...
            '<h2>Breaking Bad</h2>'+
            '<br>'+
            '<img class="imag1" src="img/BB.jpg" alt="Breaking Bad">' +
